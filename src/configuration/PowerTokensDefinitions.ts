...
export const PowerTokensDefinitions = [
    ...
    new PowerTokens({id:5, numberOfPowerTokens: 5}),
    new PowerTokens({id:6, numberOfPowerTokens: 5}),
    new PowerTokens({id:7, numberOfPowerTokens: 5}),
    new PowerTokens({id:8, numberOfPowerTokens: 5}),
    new PowerTokens({id:9, numberOfPowerTokens: 5}),
